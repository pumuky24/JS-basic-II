...
let age1 = 12 // cambio a let porque con conts no puedo cambiar el valor
if (age1 >= 18) {
    console.log("Eres mayor de edad")
} else{ console.log("no eres mayor de edad")};
...
let pet2 = "serpiente" // cambio a let porque con conts no puedo cambiar el valor)
...
const weather = "frio";
// if(weather=="soleado"){
//     console.log("Me vestiré con un pantalon corto")
// }
// else {
//     console.log("Me vestiré con un pantolon largo")

//  }

//const result = //Escribe tu código aquí;

console.log(weather === "soleado" ? "Me vestiré con un pantalon corto" : "Me vestiré con pantalón largo");
